export const notes = [
  ...
  },
  {
    ...
    type: "topic",
    title: "例题-寻址",
    question: "若CPU要执行指令为：MOV R1，#45（即将数值45传送到寄存器R1中），则该指令中采用的寻址方式为___。",
    imgs: [],
    options: [["直接寻址和立即寻址", "寄存器寻址和立即寻址", "相对寻址和直接寻址", "寄存器间接寻址和直接寻址"]],
    answer: "B。关键词：寄存器存数值",
  },
  {
    id: "section-010303",
    type: "topic",
    title: "例题-海明码",
    question: "海明码利用奇偶性检错和纠错，通过在n个数据位之间插入k个校验位，扩大数据编码的码距。若n=48，则k应至少为___。",
    imgs: [],
    options: [["4", "5", "6", "7"]],
    answer: "C",
  },
  ...
  },
  {
    ...
    imgs: [],
    options: [["指令种类丰富", "高效的流水线操作", "寻址方式较少", "硬布线控制"]],
    answer: "A",
  },
  {
    id: "section-010602",
    ...
    imgs: [],
    options: [["RISC不采用流水线技术，CISC采用流水线技术", "RISC使用复杂的指令，CISC使用简单的指令", "RISC采用很少的通用寄存器，CISC采用很多的通用寄存器", "RISC采用组合逻辑控制器，CISC普遍采用微程序控制器"]],
    answer: "D",
  },
  {
    id: "section-010603",
    type: "topic",
    title: "例题-流水线",
    question: "一条指令的执行过程可分解为取值时间=3Δt、分析时间=2Δt、执行时间=4Δt。若按串行方式执行，则10条指令全部执行完需要___Δt。若按照流水线方式执行，则执行完10条指令需要___Δt。",
    imgs: [],
    options: [["40", "70", "90", "100"], ["20", "30", "40", "45"]],
    answer: "C；D",
  },
  {
    id: "section-010401",
  ...
  },
  {
    ...
    imgs: [],
    options: [["专门的硬件自动完成", "程序员进行调度", "操作系统进行管理", "程序员和操作系统共同协调完成"]],
    answer: "A",
  },
  {
    id: "section-010501",
  ...
  },
  {
    ...
    imgs: [],
    options: [["提高总线的传输带宽", "增加总线的功能", "减少总线中信号线的总量", "提高CPU利用率"]],
    answer: "C",
  },
  {
    id: "section-010701",
    type: "topic",
    title: "例题-总线",
    question: "总线带宽为32bit，时钟频率为2000MHz，若总线上每5个时钟周期传送一个32bit的字，则该总线的带宽为___MB/s。",
    imgs: [],
  ...
  },
  {
    ...
    imgs: [],
    options: [["解密和签名", "加密和签名", "解密和认证", "加密和认证"], ["解密和签名", "加密和签名", "解密和认证", "加密和认证"]],
    answer: "A；D",
  },
  {
    id: "section-010801",
  ...
  },
  {
    ...
    type: "topic",
    title: "例题-可靠性",
    question: "某系统由下图所示的部件构成，每个部件的千小时可靠度都为R，则该系统的千小时可靠度为___。",
    imgs: ['10-jiami.png'],
    options: [["3R/2+2R/3", "R/3+R/2", "(1-(1-R)^3)(1-(1-R)^2)", "(1-(1-R)^3-(1-R)^2)"]],
    answer: "C",
  },
  {
    id: "section-01",
